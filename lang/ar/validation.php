...
/*
|--------------------------------------------------------------------------
| سطور لغة التحقق (Validation Language Lines) — العربية
|--------------------------------------------------------------------------
|
| تُستخدم هذه السطور تلقائيًا بواسطة Laravel لبناء رسائل التحقق عندما
| تفشل قاعدة تحقق ولم يتم تخصيص رسالة لها داخل Form Request.
| العنصر النائب :attribute يُستبدل باسم الحقل من مصفوفة "attributes" بالأسفل.
|
*/
...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'ظهرت :attribute في تسريب بيانات. يُرجى اختيار قيمة مختلفة.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | تُستبدل بالعنصر النائب :attribute في الرسائل أعلاه لتظهر أسماء حقول
    | مفهومة بالعربية بدلًا من أسماء الأعمدة الإنجليزية.
    |
    */
    'attributes' => [
        'name' => 'الاسم',
